...
export default class LiteracyBarChart extends Component {
	...
	handleClickFive = () => {
		this.setState({
			chartData: getStackedData(this.props.literacy, [1991, 2001], ['#5079a0', '#0a3c6b'])
		})
	} 
					...
					<Bar
						...
						options={{
							scales: {
								xAxes: [{
									type: 'category',
									labels: ["All India", "Andhra Pradesh", "Arunachal Pradesh", "Assam", "Bihar", "Chhatisgarh", "Goa", "Gujarat", "Haryana", "Himachal Pradesh", "Jammu and Kashmir", "Jharkhand", "Karnataka", "Kerala", "Madhya Pradesh", "Maharashtra", "Manipur", "Meghalaya", "Mizoram", "Nagaland", "Odisha", "Punjab", "Rajasthan", "Sikkim", "Tamil Nadu", "Tripura", "Uttar Pradesh", "Uttaranchal", "West Bengal", "A. and N. Islands", "Chandigarh", "D. and N. Haveli", "Daman and Diu", "Delhi", "Lakshadweep"],
									ticks: {
										autoSkip: false
									}
								}],
